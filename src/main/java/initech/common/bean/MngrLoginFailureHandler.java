...
public class MngrLoginFailureHandler implements AuthenticationFailureHandler {
	...
	public MngrLoginFailureHandler() {
	...
	public void onAuthenticationFailure(HttpServletRequest request,
		...
		request.setAttribute("mngrId", request.getParameter("mngrId"));
		
		// 로그인 페이지로 다시 포워딩
		RequestDispatcher dispatcher = request.getRequestDispatcher("/mngr/login");
